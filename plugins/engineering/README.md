...
- [`to-tickets`](skills/to-tickets/SKILL.md) — break a plan into tracer-bullet tickets with
  blocking edges, then publish them.
- [`triage`](skills/triage/SKILL.md) — move issues and external PRs through a triage state
  machine into agent-ready briefs.
- [`wayfinder`](skills/wayfinder/SKILL.md) — plan work too large for one session as a map
  of decision tickets.
