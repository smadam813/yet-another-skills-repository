...
- Verifies behavior that users or callers care about
...
**Implementation-detail tests**: the test is coupled to internal structure.
...
- Breaks when you refactor without changing behavior
- Has a name that describes HOW, not WHAT
- Verifies through an external channel instead of through the interface
