...
// PostToolUse adapter. It runs the Core gate and the watched-tools check.
// Then it reads stdin, builds the transform's dependencies from the real
// modules, calls the transform, and emits. Everything that decides what the
// model sees lives in lib/transform.js. This file exports nothing.
...
function main() {
  ...
  // Only the gate above and this line read the environment.
