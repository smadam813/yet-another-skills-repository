...
metadata:
  ...
  local_changes: >-
    ...
    /setup-builder-tools; GitLab merge-request example dropped.
  note: >-
...
The issue tracker should have been provided to you — run `/setup-builder-tools` if `docs/agents/issue-tracker.md` is missing.
